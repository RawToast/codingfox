...
export const COMMENT_TAG = "<!-- This is an auto-generated comment by OSS CodeFox -->";

export const COMMENT_REPLY_TAG = "<!-- This is an auto-generated reply by OSS CodeFox -->";

export const SUMMARIZE_TAG = "<!-- This is an auto-generated comment: summarize by OSS CodeFox -->";
...
`;
  ...
  async getCommentChainsWithinRange(
    ...
    const topLevelComments: typeof existingComments = [];
